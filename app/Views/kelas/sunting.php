  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="<?=site_url('kelas/tambah')?>">Simpan</a>
        </li>
  ...
  <div class="mt-4 mb-3 col-md-5">
        ...
        <?php else: ?>    
            ...
            <form method="post">
                ...
                <input type ="text" value="<?=old('nama') ?? htmlspecialchars($fetch_data->Nama) ?>" name="nama" placeholder="Masukkan Nama" class="form-control<?=$error && !empty($error_val['nama']) ? ' is-invalid' : ''?>">
                ...
                <input type ="text" value="<?=old('nilai') ?? htmlspecialchars($fetch_data->Nilai) ?>" name="nilai" placeholder="Masukkan Nilai" class="form-control<?=$error && !empty($error_val['nilai']) ? ' is-invalid' : ''?>">
